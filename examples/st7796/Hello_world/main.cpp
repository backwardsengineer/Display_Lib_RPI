/*! 
	@file examples/ST7796/Hello_world/main.cpp
...
#include <iostream>
#include <lgpio.h>
#include "ST7796_TFT_LCD_RDL.hpp"
...
int8_t RST_TFT  = 13;
int8_t DC_TFT   = 6;
int  GPIO_CHIP_DEVICE = 0; // RPI 5 = 4 , other RPIs = 0

uint8_t OFFSET_COL = 0;  // 2, These offsets can be adjusted for any issues->
uint8_t OFFSET_ROW = 0; // 3, with manufacture tolerance/defects at edge of display
uint16_t TFT_WIDTH = 320;// Screen width in pixels
uint16_t TFT_HEIGHT = 480; // Screen height in pixels
...
uint8_t SetupHWSPI(void)
{
	...
	std::cout << "ST7796 library version : " << GetRDLibVersionNum()<< std::endl;
