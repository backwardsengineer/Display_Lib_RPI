 /*!
	@file     ST7796_TFT_LCD_RDL.hpp
	@author   Gavin Lyons
	@brief    Library header file for ST7796_TFT_RPI library.
*/
...
/*!
	@brief Class to control ST7796 TFT basic functionality.
*/
class ST7796_TFT : public color16_graphics
{
...
private:
	...
	rpiDisplay_Return_Codes_e TFTST7796Initialize(void);
	void cmd89(void);
	...
	uint8_t _colstart2 = 0;         /**< Offset from the right for ST7796*/
	uint8_t _rowstart2 = 0;         /**< Offset from the bottom for ST7796*/
	uint16_t _widthStartTFT = 320;  /**<  never change after first init */ // was 240 for ST7789
	uint16_t _heightStartTFT = 480; /**< never change after first init */  // was 320 for ST7789
